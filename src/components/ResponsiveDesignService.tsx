        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 lg:mb-24">
          ...
          <div className="sec lg:col-span-5">
            ...
            <div
              ...
              className={`group border border-[#F9FFEB] p-5 sm:p-10 cursor-pointer transition-all duration-300 ${
                activeSection === "figma"
            ...
            <div
              ...
              className={`group border border-[#F9FFEB] p-5 sm:p-10 rounded-br-[20px] cursor-pointer transition-all duration-300 ${

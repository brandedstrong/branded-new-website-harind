...
const Shopify = () => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="bg-black min-h-screen flex flex-col justify-center items-center px-8 md:px-16 lg:px-24 py-16">
        <div className="max-w-6xl mx-auto text-center space-y-4">
          {/* Main Headline */}
          <div className="space-y-4">
            <h1 className="hidden sm:block sm:text-4xl max-w-3xl mx-auto  font-bold text-white leading-tight uppercase">
          ...
          <div className="relative inline-block">
            ...
            <div className="absolute top-2 -left-4 bg-gradient-to-r from-[#B0E63B] via-[#E0E23B] to-[#E0E23B] text-white px-8 py-4 rounded-full transform rotate-3 z-10">
              <span className="text-2xl md:text-3xl lg:text-4xl font-normal uppercase tracking-wide">
                YOUR CUSTOMERS HAVE TOO
              </span>
            </div>
            {/* Middle banner - white, centered */}
            <div className="relative bg-white top-[20px] text-black px-8 py-4 rounded-full transform -rotate-1 z-20">
              <span className="text-2xl md:text-3xl lg:text-4xl font-normal uppercase tracking-wide">
                YOUR CUSTOMERS <span className="font-bold">HAVE TOO</span>
              </span>
            </div>
            {/* Bottom banner - dark, positioned right and down */}
            <div className="absolute -bottom-[27px] -right-0 bg-[#1B1B1B] px-8 py-4 rounded-full transform rotate-6 z-10">
              <span className="text-2xl md:text-3xl lg:text-4xl font-normal uppercase tracking-wide bg-gradient-to-r from-[#B0E63B] via-[#E0E23B] to-[#E0E23B] bg-clip-text text-transparent">
                YOUR CUSTOMERS HAVE TOO
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-row gap-5 items-center justify-center">
            {/* CTA Button */}
            <div className="pt-8">
              <button className="bg-gradient-to-r from-[#B0E63B] via-[#E0E23B] to-[#E0E23B] text-black px-10 py-4 rounded-full font-bold text-lg cursor-pointer transition-colors duration-300 uppercase tracking-wide">
                UPGRADE YOUR STORE
              </button>
            </div>

            {/* Trust Indicators */}
            <div className="pt-12 flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
              <div className="text-white text-center">
                <p className="text-sm font-medium">Trusted by 200+</p>
                <p className="text-sm font-medium">Shopify Owners</p>
                <p className="text-sm font-medium">Owners Across the U.S.</p>
              </div>
      ...
      <div className="relative flex  flex-col overflow-hidden min-h-[780px]">
        <img
      ...
      <div className="bg-black py-16 px-8 md:px-16 lg:px-24 -mt-15">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 gap-12 items-center relative">
            ...
            <div className="absolute left-[-130px] flex justify-center items-center">
              <img

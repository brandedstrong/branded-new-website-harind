...
const slides = [
  {
    ...
    subtitle: "WEB DESIGN",
    leftTitle: "MONTHLY",
    leftSubtitle: "UPDATES",
    leftHighlight: "EXCLUDED",
    leftDescription: "Avoid large upfront costs, hiring in-house, paying per change or surprises",
  },
  {
    id: 2,
    title: "VIDEO",
    subtitle: "PRODUCTION",
    leftTitle: "CINEMATIC",
    leftSubtitle: "QUALITY",
    leftHighlight: "INCLUDED",
    leftDescription: "Professional video production with unlimited revisions and fast turnaround",
  },
];
  ...
  return (
    <React.Fragment>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center relative overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.h1
                  ...
                  className="text-5xl sm:text-8xl font-semibold text-white leading-tight flex flex-col items-center relative"
                >
                  {currentSlideData.title} <br /> {currentSlideData.subtitle}
                  {/* Arrow Icon - Clickable */}
                  <div className="absolute bottom-5 right-[10px] hidden lg:flex flex-col items-center gap-3 z-30">
                    <motion.div
              ...
              <div className="flex flex-col items-center gap-3 mt-4 lg:hidden">
                <motion.button
                  onClick={handleNextSlide}
                  className="bg-white/10 backdrop-blur-sm rounded-full p-3 cursor-pointer"
                ...
                >
                  <div className="flex justify-center text-center mb-6 mt-6 gap-2">
                    <div className="text-white sm:text-3xl text-xl font-bold ">
                      {currentSlideData.leftTitle} {currentSlideData.leftSubtitle}
                    </div>
                    <div
            ...
            <div className="relative z-10 lg:-top-[80px]">
              <AnimatePresence mode="wait">
                <motion.img
                  key={currentSlide}
                  src={currentSlide === 0 ? IMAGES.Laptop_Img : IMAGES.Sliderimg_02}
                  alt="hero"
            ...
            <div className="absolute top-[240px] left-0 z-10 hidden lg:block">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="flex max-w-[340px] items-center gap-4"
                >
                  <div>
                    <div className="text-white text-lg sm:text-xl font-bold ">
                      {currentSlideData.leftTitle}
                      <br />
                      {currentSlideData.leftSubtitle}
                    </div>
                    <div
      ...
      <div className="relative bg-black  overflow-hidden">
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-32 ">
          <div className="max-w-[750px] gap-12 lg:gap-10 items-center">
            ...
            <div className="md:absolute right-0 top-[50px] opacity-100 md:opacity-30 xl:opacity-100">
              <img
      ...
      {/* Text Big */}
      <div className="overflow-hidden bg-black pt-8 sm:pt-16 pb-6 space-y-8">
      ...
      <div className="bg-[#F0F8E8] py-16 md:py-16 lg:py-20 relative -top-[180px]">

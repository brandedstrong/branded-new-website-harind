  ...
  return (
    <React.Fragment>
      ...
      <div className="bg-black min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-center justify-center">
            ...
            >
              <motion.button
                className="bg-gradient-to-r from-[#B0E63B] via-[#E0E23B] to-[#E0E23B] text-black px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg md:text-xl cursor-pointer transition-colors duration-300 uppercase tracking-wide w-full sm:w-auto"
                whileHover={{
                  scale: 1.05,
            ...
            {/* Trust Indicators */}
            <motion.div
              className="pt-6 sm:pt-8 lg:pt-12 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-12"
      ...
      <div className="relative bg-black overflow-hidden">
        ...
        <div className="flex absolute justify-center lg:justify-end order-1 lg:order-2 top-[190px] -right-0 ">
          <div className="relative opacity-40 lg:opacity-90 xl:opacity-100">
            <img
              src={IMAGES.Laptop_Rock_Img}
              alt="hero"
              className="w-full object-contain max-w-[300px] sm:max-w-[400px] md:max-w-[550px] lg:max-w-[600px] h-auto"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-black py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Subheader */}
          <div className="mb-8 sm:mb-12 lg:mb-16 w-full">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white leading-tight mb-4 max-w-4xl mx-auto text-start sm:text-center">
              We combine{" "}
              <span
                className="bg-gradient-to-r from-[#B0E63B] via-[#E0E23B] to-[#E0E23B] bg-clip-text text-transparent"
                style={{
      ...
      <div className="bg-[#F9FFEB] py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16">
            ...
            <div className="space-y-3 sm:space-y-4 p-4 sm:p-6 flex flex-col items-center justify-center md:flex-none  md:items-start  md:justify-start md:text-left text-center">
      ...
      <div className="bg-black py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 -mt-[260px] lg:-mt-[260px]">
                  ...
                  <div className="overflow-hidden border border-gray-700/50 rounded-2xl">
                    ...
                    >
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <svg
                          className={`w-6 h-6 transition-all duration-300 ${expandedSection === 0
                  ...
                  <div className="rounded-2xl overflow-hidden border border-gray-700/50">
                    ...
                    >
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <svg
                          className={`w-6 h-6 transition-all duration-300 ${expandedSection === 1
                            ? "text-[#c8ff00] rotate-180"
                            : "text-gray-400"
                            }`}
                          fill="none"
                  ...
                  <div className="rounded-2xl overflow-hidden border border-gray-700/50">
                    ...
                    >
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <svg
                          className={`w-6 h-6 transition-all duration-300 ${expandedSection === 2
                            ? "text-[#c8ff00] rotate-180"
                            : "text-gray-400"
                            }`}
                          fill="none"
                  ...
                  <div className="rounded-2xl overflow-hidden border border-gray-700/50">
                    ...
                    >
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <svg
                          className={`w-6 h-6 transition-all duration-300 ${expandedSection === 3
                            ? "text-[#c8ff00] rotate-180"
                            : "text-gray-400"
                            }`}
                          fill="none"
                  ...
                  <div className="rounded-2xl overflow-hidden border border-gray-700/50">
                    ...
                    >
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <svg
                          className={`w-6 h-6 transition-all duration-300 ${expandedSection === 4
                            ? "text-[#c8ff00] rotate-180"
                            : "text-gray-400"
                            }`}
                          fill="none"

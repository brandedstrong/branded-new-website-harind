    ...
    <React.Fragment>
          ...
          <div className="w-full flex flex-col items-center justify-center">
            <div className="text-center w-full flex flex-col items-center justify-center bg-white/10 backdrop-blur-lg rounded-[20px] p-8  border-t-2 border-b-2 border-white/35 max-w-3xl">
              <h2 className="text-3xl md:text-8xl font-extrabold uppercase leading-[40px] sm:leading-[100px] mb-4">
                ...
                <br />
                <span className="text-[#B0E63B] italic font-light">
                  On-Site Video
                </span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
                ...
                {/* Pricing Text */}
                <motion.p
                  className="text-white/80 text-sm font-ubuntu font-light shrink-0 text-center sm:text-left"
                ...
                {/* 5 Star Rating */}
                <motion.div
                  className="flex space-x-1 mt-2 sm:mt-0"
      ...
      <div className="relative bg-black  overflow-hidden">
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-5  pb-20">
          <div className="max-w-[500px] gap-12 lg:gap-10 items-center ">
            {/* Left Content */}
            <div className="space-y-4 relative z-10">
              {/* Main Headline */}
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-6xl  font-medium text-white leading-tight uppercase">
              ...
              <p className="text-sm sm:text-xl  text-[#F9FFEB] font-medium uppercase leading-relaxed">
                with Professional Video & Ads Every Single Month
              </p>
              <p className="text-sm  text-[#F9FFEB] leading-relaxed max-w-2xl">
                ...
                every ad. Stand out from the noise with professional video
                content that stops the scroll, builds trust, and converts
            ...
            <div className="md:absolute -right-[100px] top-[30px] opacity-100 md:opacity-30 xl:opacity-100">
              <img
...
export default MonthlyVideoProduction;
